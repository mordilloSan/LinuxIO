...
func TestRenderTypesCoversCoreRouteShapes(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"start_container: { input: string; request: ContainerIDRequest; result: void };",
		"list_containers: { input: void; request: void; result: ContainerInfo[] };",
		"jobs: {",
		"list: { input: JobListRequest; request: JobListRequest; result: JobSnapshot[] };",
		"compose: { input: DockerComposeRequest; request: DockerComposeRequest; result: JobSnapshot };",
		"create_samba_share: {",
		"input: ShareSambaRequest; request: ShareSambaRequest;",
		"archive: { input: FileArchiveRequest; request: FileArchiveRequest; result: JobSnapshot };",
		"system_prune: {",
		"input: DockerSystemPruneRequest; request: DockerSystemPruneRequest;",
		"export interface DockerSetAutoUpdateRequest",
		"export interface MessageResponse",
		"set_auto_update: {",
		"input: DockerSetAutoUpdateRequest; request: DockerSetAutoUpdateRequest;",
		"set_ntp_servers: { input: string[]; request: NTPServersRequest; result: void };",
		"validate_compose: {",
		"input: string; request: ContentRequest;",
...
func TestRenderTypesFromGoContracts(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"note?: string;",
		"noop: { input: void; request: void; result: void };",
		"scalar: { input: GoldenScalarRequest; request: GoldenScalarRequest; result: GoldenResponse };",
		"nested: { input: GoldenNestedRequest; request: GoldenNestedRequest; result: GoldenResponse };",
		"runner: { input: string[]; request: NTPServersRequest; result: JobSnapshot };",
	} {
		if !strings.Contains(out, expected) {
