...
func routeBindings(rt runtime.Runtime, handlers dockerHandlers) apischema.BindingSet {
	return apischema.Bindings(
		...
		apischema.Job[apischema.ContainerIDRequest, apischema.NoResponse]("docker.start_container").HandleVoid(handlers.handleStartContainer),
		apischema.Job[apischema.ContainerIDRequest, apischema.NoResponse]("docker.stop_container").HandleVoid(handlers.handleStopContainer),
		apischema.Job[apischema.ContainerIDRequest, apischema.NoResponse]("docker.remove_container").HandleVoid(handlers.handleRemoveContainer),
		apischema.Job[apischema.ContainerIDRequest, apischema.NoResponse]("docker.restart_container").HandleVoid(handlers.handleRestartContainer),
		apischema.Query[apischema.NoRequest, []apischema.DockerImage]("docker.list_images").Handle(handlers.handleListImages),
		apischema.Job[apischema.ImageIDRequest, apischema.NoResponse]("docker.delete_image").HandleVoid(handlers.handleDeleteImage),
		apischema.Query[apischema.NoRequest, []apischema.DockerNetwork]("docker.list_networks").HandleEvents(handlers.handleListNetworks),
		apischema.Job[apischema.NameRequest, apischema.NoResponse]("docker.create_network").HandleVoid(handlers.handleCreateNetwork),
		apischema.Job[apischema.IDRequest, apischema.NoResponse]("docker.delete_network").HandleVoid(handlers.handleDeleteNetwork),
		apischema.Query[apischema.NoRequest, []apischema.DockerVolume]("docker.list_volumes").HandleEvents(handlers.handleListVolumes),
		apischema.Job[apischema.NameRequest, apischema.NoResponse]("docker.create_volume").HandleVoid(handlers.handleCreateVolume),
		apischema.Job[apischema.NameRequest, apischema.NoResponse]("docker.delete_volume").HandleVoid(handlers.handleDeleteVolume),
		...
		apischema.Job[apischema.ProjectNameRequest, apischema.ComposeActionResult]("docker.compose_up").Handle(handlers.handleComposeUp),
		apischema.Job[apischema.ProjectNameRequest, apischema.ComposeActionResult]("docker.compose_down").Handle(handlers.handleComposeDown),
		apischema.Job[apischema.ProjectNameRequest, apischema.ComposeActionResult]("docker.compose_stop").Handle(handlers.handleComposeStop),
		apischema.Job[apischema.ProjectNameRequest, apischema.ComposeActionResult]("docker.compose_restart").Handle(handlers.handleComposeRestart),
		apischema.Job[apischema.DeleteStackRequest, apischema.DeleteStackResult]("docker.delete_stack").HandleEvents(handlers.handleDeleteStack),
		...
		apischema.Query[apischema.ContentRequest, apischema.NoResponse]("docker.normalize_compose", apischema.NoEndpoint()).HandleEvents(handlers.handleNormalizeCompose),
		...
		apischema.Job[apischema.ProjectNameRequest, apischema.NoResponse]("docker.delete_compose_stack", apischema.NoEndpoint()).HandleEvents(handlers.handleDeleteComposeStack),
		...
		apischema.Query[apischema.IdentifierRequest, apischema.DockerIconURIResponse]("docker.get_icon_uri").HandleEvents(handlers.handleGetIconURI),
		apischema.Query[apischema.IdentifierRequest, apischema.DockerIconDataResponse]("docker.get_icon").HandleEvents(handlers.handleGetIcon),
		apischema.Query[apischema.IdentifierRequest, apischema.DockerIconInfoResponse]("docker.get_icon_info").HandleEvents(handlers.handleGetIconInfo),
