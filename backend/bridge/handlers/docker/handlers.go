...
func routeBindings(rt runtime.Runtime, handlers dockerHandlers) apischema.BindingSet {
	return apischema.Bindings(
		apischema.Call[apischema.NoRequest, []apischema.ContainerInfo]("docker.list_containers").Handle(handlers.handleListContainers),
		...
		apischema.Call[apischema.NoRequest, []apischema.DockerImage]("docker.list_images").Handle(handlers.handleListImages),
		apischema.Call[apischema.ImageIDRequest, apischema.NoResponse]("docker.delete_image").HandleVoid(handlers.handleDeleteImage),
		apischema.Call[apischema.NoRequest, []apischema.DockerNetwork]("docker.list_networks").Handle(handlers.handleListNetworks),
		...
		apischema.Call[apischema.NoRequest, []apischema.DockerVolume]("docker.list_volumes").Handle(handlers.handleListVolumes),
		...
		apischema.Call[apischema.NoRequest, []*apischema.ComposeProject]("docker.list_compose_projects").Handle(handlers.handleListComposeProjects),
		apischema.Call[apischema.ProjectNameRequest, *apischema.ComposeProject]("docker.get_compose_project").Handle(handlers.handleGetComposeProject),
		...
		apischema.Call[apischema.NoRequest, apischema.DockerFoldersResponse]("docker.get_docker_folders").Handle(handlers.handleGetDockerFolders),
		apischema.Call[apischema.ContentRequest, apischema.ValidateComposeResponse]("docker.validate_compose").Handle(handlers.handleValidateCompose),
		...
		apischema.Call[apischema.StackNameRequest, apischema.ComposeFilePathResponse]("docker.get_compose_file_path").Handle(handlers.handleGetComposeFilePath),
		apischema.Call[apischema.DirPathRequest, apischema.DirectoryValidationResult]("docker.validate_stack_directory").Handle(handlers.handleValidateStackDirectory),
		...
		apischema.Call[apischema.NoRequest, *apischema.DockerSystemInfo]("docker.get_docker_info").Handle(handlers.handleGetDockerInfo),
		...
		apischema.Call[apischema.IdentifierRequest, apischema.DockerIconInfoResponse]("docker.get_icon_info").Handle(handlers.handleGetIconInfo),
		...
		apischema.Call[apischema.NoRequest, apischema.DockerContainerAutoUpdateState]("docker.get_container_auto_update").Handle(handlers.handleGetContainerAutoUpdate),
		...
		apischema.Call[apischema.NoRequest, apischema.CaddyStatusResponse]("docker.get_caddy_status").Handle(handlers.handleGetCaddyStatus),
