...
func routeBindings(rt runtime.Runtime, handlers dockerHandlers) apischema.BindingSet {
	return apischema.Bindings(
		...
		apischema.Query[apischema.NoRequest, []string]("docker.list_auto_update_containers").Handle(handlers.handleListAutoUpdateContainers),
		apischema.Job[apischema.DockerSetAutoUpdateRequest, apischema.MessageResponse]("docker.set_auto_update").Handle(handlers.handleSetAutoUpdate),
