...
var api = apischema.Bindings(
	apischema.Call[apischema.NoRequest, []apischema.AccountUser]("accounts.list_users").Handle(handleListUsers),
	apischema.Call[apischema.UsernameRequest, apischema.AccountUserDetails]("accounts.get_user_details").Handle(handleGetUserDetails),
	apischema.Call[apischema.UsernameRequest, []apischema.AccountUserLogin]("accounts.list_user_logins").Handle(handleListUserLogins),
	...
	apischema.Call[apischema.NoRequest, []apischema.AccountGroup]("accounts.list_groups").Handle(handleListGroups),
	...
	apischema.Call[apischema.NoRequest, []string]("accounts.list_shells").Handle(handleListShells),
)
