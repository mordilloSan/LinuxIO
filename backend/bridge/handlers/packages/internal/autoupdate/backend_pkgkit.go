...
func (*pkgkitBackend) ApplyOfflineNow(ctx context.Context) error {
	return packagekit.Run(ctx, packagekit.OperationOptions{NoRetry: true}, func(session packagekit.ClientSession) error {
...
func pkTransactionCall(ctx context.Context, session packagekit.ClientSession, method string, args ...any) error {
...
func pkTransactionCallWithUpdates(ctx context.Context, session packagekit.ClientSession) error {
...
func collectPackageKitUpdates(ctx context.Context, session packagekit.ClientSession) ([]string, error) {
...
func downloadPackageKitUpdates(ctx context.Context, session packagekit.ClientSession, packageIDs []string) error {
	trans, err := session.CreateTransaction(20)
	if err != nil {
		return err
	}
