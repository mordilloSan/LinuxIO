...
func routeBindings(rt runtime.Runtime) apischema.BindingSet {
	...
	return apischema.Bindings(
		apischema.Call[apischema.NoRequest, apischema.CapabilitiesResponse]("system.get_capabilities").Handle(handleGetCapabilities),
		apischema.Call[apischema.NoRequest, *apischema.CPUInfoResponse]("system.get_cpu_info").Handle(handleGetCPUInfo),
		apischema.Call[apischema.NoRequest, []apischema.SensorGroup]("system.get_sensor_info").Handle(handleGetSensorInfo),
		apischema.Call[apischema.NoRequest, apischema.MotherboardInfo]("system.get_motherboard_info").Handle(handleGetMotherboardInfo),
		apischema.Call[apischema.NoRequest, *apischema.MemoryInfoResponse]("system.get_memory_info").Handle(handleGetMemoryInfo),
		apischema.Call[apischema.NoRequest, apischema.HostInfo]("system.get_host_info").Handle(handleGetHostInfo),
		apischema.Call[apischema.NoRequest, float64]("system.get_uptime").Handle(handleGetUptime),
		apischema.Call[apischema.NoRequest, []apischema.FilesystemInfo]("system.get_fs_info").Handle(handleGetFilesystemInfo),
		apischema.Call[apischema.NoRequest, []apischema.ProcessInfo]("system.get_processes").Handle(handleGetProcesses),
		...
		apischema.Call[apischema.NoRequest, []apischema.GpuDevice]("system.get_gpu_info").Handle(handleGetGPUInfo),
		...
		apischema.Call[apischema.NoRequest, *apischema.SystemInfo]("system.get_system_info").Handle(handleGetSystemInfo),
		apischema.Call[apischema.NoRequest, []apischema.PCIDevice]("system.get_pci_devices").Handle(handleGetPCIDevices),
		apischema.Call[apischema.NoRequest, []apischema.MemoryModule]("system.get_memory_modules").Handle(handleGetMemoryModules),
		...
		apischema.Call[apischema.FailedLoginEventsRequest, []apischema.AccountUserLogin]("system.list_failed_login_events", apischema.Privileged()).Handle(handlers.handleListFailedLoginEvents),
		...
		apischema.Call[apischema.NoRequest, string]("system.get_server_time").Handle(handleGetServerTime),
		apischema.Call[apischema.NoRequest, []string]("system.get_timezones").Handle(handleGetTimezones),
	)
}
