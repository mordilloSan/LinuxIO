...
export const CAPABILITIES = [
  ...
  {
    wire: "docker_updates",
    state: "dockerUpdatesAvailable",
    label: "Docker updates",
    description: "Native container update checks and scheduled application",
    readyText: "The LinuxIO Docker update runner is installed.",
    dependency: "linuxio",
    icon: "mdi:update",
