 ...
 * exactly the cards they are when loose. Purely presentational — the grid
 * wraps it in the same SortableCard as every other card, so the whole band
 * holds, drags, and reorders as one wide item.
 */
